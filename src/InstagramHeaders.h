...
// Forward declarations for every class this header defines, so a property can
// name a type that is only laid out further down.
@class FLEXAlert;
@class FLEXAlertAction;
@class FLEXManager;
@class IGAccountSwitcher;
@class IGActionableConfirmationToastPresenter;
@class IGActionableConfirmationToastViewModel;
@class IGAnimatablePlaceholderTextField;
@class IGAnimatablePlaceholderTextFieldContainer;
@class IGAppCoordinator;
@class IGAudioStatusAnnouncer;
@class IGBadgedNavigationButton;
@class IGBaseMedia;
@class IGCommentThreadConfiguration;
@class IGCommentThreadViewController;
@class IGCoreTextView;
@class IGCreationActionBarButton;
@class IGCreationActionBarLabeledButton;
@class IGDSMenuItem;
@class IGDSSegmentedPillBarView;
@class IGDirectAggregatedMediaViewerViewController;
@class IGDirectCommandSystemResult;
@class IGDirectCommandSystemRow;
@class IGDirectCommandSystemViewModel;
@class IGDirectComposer;
@class IGDirectComposerConfig;
@class IGDirectGatingService;
@class IGDirectInboxConfig;
@class IGDirectInboxFeatureManager;
@class IGDirectInboxHeaderCellViewModel;
@class IGDirectInboxNavigationHeaderView;
@class IGDirectInboxSearchAIAgentsPillsContainerCell;
@class IGDirectInboxSearchAIAgentsSuggestedPromptRowCell;
@class IGDirectInboxSuggestedThreadCellViewModel;
@class IGDirectLeftAlignedTitleView;
@class IGDirectMediaPickerConfig;
@class IGDirectMediaPickerGalleryConfig;
@class IGDirectMessageContentMutation;
@class IGDirectRealtimeIrisDelta;
@class IGDirectRealtimeIrisDeltaPayload;
@class IGDirectRealtimeIrisThreadDelta;
@class IGDirectRealtimeIrisThreadDeltaPayload;
@class IGDirectRecipientCellViewModel;
@class IGDirectShareRecipient;
@class IGDirectThreadThemePickerOption;
@class IGDirectThreadViewController;
@class IGDirectThreadViewDrawingViewController;
@class IGDirectTypingStatus;
@class IGDirectTypingStatusService;
@class IGDirectVisualMessage;
@class IGDirectVisualMessageViewerController;
@class IGDirectVisualMessageViewerViewModeAwareDataSource;
@class IGDiscoveryGridItem;
@class IGExploreChipBarView;
@class IGExploreGridViewController;
@class IGExploreViewController;
@class IGFeedItem;
@class IGFeedItemMediaCell;
@class IGFeedItemPagePhotoCell;
@class IGFeedItemPhotoCell;
@class IGFeedItemPhotoCellConfiguration;
@class IGFeedItemUFICell;
@class IGFeedItemVideoView;
@class IGFeedPhotoView;
@class IGFollowButtonViewConfiguration;
@class IGFollowController;
@class IGGalleryAssetProvider;
@class IGGalleryDataSource;
@class IGGalleryImageStickerView;
@class IGGalleryVideoStickerModel;
@class IGGalleryVideoStickerView;
@class IGGrowingTextView;
@class IGHomeFeedHeaderView;
@class IGImageProgressView;
@class IGImageRequest;
@class IGImageSpecifier;
@class IGImageView;
@class IGImageWithAccessoryButton;
@class IGInstagramAppDelegate;
@class IGLabel;
@class IGLabelItemViewModel;
@class IGLabelSupplementaryView;
@class IGLazyView;
@class IGLiquidGlassInteractiveTabBar;
@class IGMainAppScrollingContainerViewController;
@class IGMainAppSurfaceIntent;
@class IGMainFeedAppHeaderController;
@class IGMedia;
@class IGModernFeedVideoCell;
@class IGPageMediaView;
@class IGPhoto;
@class IGPostItem;
@class IGPresenceManager;
@class IGPresencePeriodicScheduler;
@class IGProfileConfig;
@class IGProfileMenuSheetViewController;
@class IGProfilePictureImageView;
@class IGProfilePicturePreviewViewController;
@class IGProfileSheetTableViewCell;
@class IGProfileViewController;
@class IGRefreshControl;
@class IGRootViewController;
@class IGSaveHomeIntentTarget;
@class IGSearchBar;
@class IGSearchBarConfig;
@class IGSearchBarDonutButton;
@class IGSearchResultViewModel;
@class IGSeeAllItemConfiguration;
@class IGShakeWindow;
@class IGShimmeringGridView;
@class IGStatefulVideoPlayer;
@class IGStickerGalleryViewController;
@class IGStoriesMidcardsController;
@class IGStoryColorPaletteView;
@class IGStoryEyedropperToggleButton;
@class IGStoryFullscreenDefaultFooterView;
@class IGStoryFullscreenOverlayView;
@class IGStoryFullscreenSectionController;
@class IGStoryGalleryConfiguration;
@class IGStoryMediaCompositionEditingViewController;
@class IGStoryModernVideoView;
@class IGStoryPhotoView;
@class IGStoryPostCaptureEditingViewController;
@class IGStoryStickerTrayViewController;
@class IGStoryTextEntryControlsOverlayView;
@class IGStoryTextEntryViewController;
@class IGStoryTrayViewModel;
@class IGStoryVideoView;
@class IGStoryViewerDataStore;
...
@class IGSundialFeedViewController;
@class IGSundialViewerBottomBar;
@class IGSundialViewerCarouselCell;
@class IGSundialViewerNavigationBarOld;
@class IGSundialViewerPhotoCell;
@class IGSundialViewerPhotoView;
@class IGSundialViewerVerticalUFI;
@class IGSundialViewerVideoCell;
@class IGTabBar;
@class IGTabBarButton;
@class IGTabBarController;
@class IGTabBarControllerSwipeCoordinator;
@class IGTabBarViewControllerManager;
@class IGTableViewCell;
@class IGTallNavigationBarView;
@class IGTapButton;
@class IGUFIButtonBarView;
@class IGUFIButtonWithCountsView;
@class IGUFIInteractionCountsView;
@class IGURLHandler;
@class IGUnifiedVideoCollectionView;
@class IGUser;
...
@class IGWindow;
@class _TtC19IGSundialFeedFooter24IGSundialViewerBottomBar;
@class _TtC19IGSundialFeedFooter30IGSundialViewerBottomBarConfig;
@class _TtC19IGSundialFeedFooter37IGSundialViewerBottomBarCommentConfig;
@class _TtC19IGSundialFeedFooter42IGSundialViewerBottomBarCommentContentView;
@class _TtC27IGGalleryDestinationToolbar31IGGalleryDestinationToolbarView;
@class _TtC29IGConsumerSubsStoryPeekPlugin30IGConsumerSubsStoryPeekManager;
@class _TtC32IGSundialOrganicCTAContainerView32IGSundialOrganicCTAContainerView;
@class _TtC35IGConsumerSubsStoryPeekDirectPlugin36IGConsumerSubsStoryPeekDirectManager;
